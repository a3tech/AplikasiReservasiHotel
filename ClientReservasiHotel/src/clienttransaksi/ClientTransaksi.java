...
public class ClientTransaksi extends UnicastRemoteObject
implements RemoteClientLogin{
    Registry registry;
    RemoteServerLogin rsl;
    RemoteServerTransaksi rst;
    FrmDataTransaksi form = new FrmDataTransaksi();
    int iClient = 0;
    String namaOperator; 
    public ClientTransaksi(String namaOp) throws RemoteException,
            NotBoundException{
        super();
        namaOperator = namaOp;
