...
public class ClientMenuKaryawan extends UnicastRemoteObject
implements RemoteClientLogin{
    Registry registry;
    RemoteServerLogin rsl;
    RemoteServerTransaksi rst;
    MenuUtamaKaryawan form = new MenuUtamaKaryawan();
    int iClient = 0;
    String namaOperator;
    public ClientMenuKaryawan(String namaOp) throws RemoteException,
            NotBoundException{
        super();
        namaOperator = namaOp;
