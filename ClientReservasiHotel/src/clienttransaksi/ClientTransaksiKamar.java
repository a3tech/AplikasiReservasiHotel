...
public class ClientTransaksiKamar extends UnicastRemoteObject
implements RemoteClientLogin{
    Registry registry;
    RemoteServerLogin rsl;
    RemoteServerTransaksi rst;
    FrmTransaksiKamar form = new FrmTransaksiKamar();
    int iClient = 0;
    String namaOperator;
    public ClientTransaksiKamar(String namaOp) throws RemoteException,
            NotBoundException{
        super();
        namaOperator = namaOp;
