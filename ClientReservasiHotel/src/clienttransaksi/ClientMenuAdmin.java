...
public class ClientMenuAdmin extends UnicastRemoteObject
implements RemoteClientLogin{
    Registry registry;
    RemoteServerLogin rsl;
    RemoteServerTransaksi rst;
    MenuUtamaAdmin form = new MenuUtamaAdmin();
    FrmKamar form1 = new FrmKamar();
    int iClient = 0;
    String namaOperator;
    public ClientMenuAdmin(String namaOp) throws RemoteException,
            NotBoundException{
        super();
        namaOperator = namaOp;
